...
def main():
    ...
    ## because of the OOM bug in tensorflow had to adapt to continue
    ## from previous ga instance.
    ...
    if latest_file is not None:
        ...
        ga = continue_run_ga(latest_file)
    else:
        ...
        Xtoencode=data.df_featurized.fillna(-1).sample(10000, random_state=1)
        ## check if there are nan values
        ...
        genetic_hypertune_autoencoder(prefix_name = 'geneticVAE_MMmp_gap',
            ...
            gene_space = [[0.5,1.0,1.5,2.0,2.5],list(range(30,240,30)),
                        [0.0005, 0.001, 0.002],[16, 32, 64, 128, 256],[1,2]],
            # initial_population = [
            ...
            # [2.0, 10, 0.001, 16, 1],
            # [1.5, 90, 0.001, 32, 1],],
            ga_settings = {'num_generations': 15, 'num_parents_mating': 4, 
