...
import sys
sys.path.append('./')
from genetic_hypertune import genetic_hypertune_autoencoder, read_past_ga, continue_run_ga
...
Xtoencode=Xtoencode.sample(2000, random_state=1)
print(Xtoencode)
...
genetic_hypertune_autoencoder(prefix_name = 'geneticVAE_MMmp_gap',
    ...
    gene_space = [[1.0,1.5,2.0,2.5],list(range(30,240,30)),
                  [0.0005, 0.001, 0.002],[128,256],[1,2]],
    # initial_population = [
    ...
    # [2.0, 10, 0.001, 16, 1],
    # [1.5, 90, 0.001, 32, 1],],
    ga_settings = {'num_generations': 10, 'num_parents_mating': 4, 
    'sol_per_pop': 5, 'parent_selection_type': 'rws', 'keep_elitism': 2},
    savedir = './tmp/',
    logfile = 'EncoderResults.txt',
    random_state = 1,
    )

# read_past_ga(filename='ga_instance_generation_2.pkl')
# continue_run_ga(filename='ga_instance_generation_2.pkl')